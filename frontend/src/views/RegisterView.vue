  ...
  <div class="bg-white grow w-screen flex items-center justify-center">
    <div
      ...
      <FormKit type="form" @submit="submit" id="register-form" class="flex flex-col"
        ...
        <p class="pb-8">Registrieren Sie sich bitte mit Ihrer GSO-E-Mail-Adresse. Sie bekommen anschließend eine
          Bestätigungs E-Mail.
      ...
      <FormKit type="button" label="Zurück" class="justify-self-end" @click="router.push({ path: '/' })"></FormKit>
    </div>
  </div>
</template>
