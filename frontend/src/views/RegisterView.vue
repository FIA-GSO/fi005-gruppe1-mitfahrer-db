  ...
  <main class="h-full">
    ...
    <div class="bg-white pt-8 h-full">
      <div
        ...
        <FormKit type="form" @submit="submit" id="register-form" class="flex flex-col" submit-label="Registrieren">
          <h1 class="font-sans dont-bold text-3xl text-center pb-16">
            Registrieren
          </h1>
          <FormKit type="text" name="email" validation="required|email" label="GSO-E-Mail-Adresse" help="Bitte geben Sie eine gültige GSO-E-Mail-Adresse ein."
