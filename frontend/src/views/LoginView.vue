    ...
    <div class="bg-white pt-8 h-full">
        <div class="container bg-white xs:rounded-none sm:rounded sm:max-w-md mx-auto xs:w-screen md:w-auto center sm:border-2 sm:border-gray-400">
            <form ref="form" v-on:submit.prevent="login" class="flex flex-col p-8">
                ...
                <input type="submit"  value="Login" v-on:click="login" class="bg-white rounded border-2 border-gray-400 h-16 text-xl mb-8 hover:cursor-pointer hover:bg-gray-400 hover:text-white transition hover:ease-in-out active:bg-gray-600 outline-1 outline-gray-600">
